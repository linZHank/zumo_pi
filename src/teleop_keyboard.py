...
class Robot(object):
  ...
  def forward(self, speed, seconds=None):
    ...
    print("Moving forward @ speed: {}, for {} seconds".format(speed, seconds))
  ...
  def backward(self, speed, seconds=None):
    ...
    print("Moving backward @ speed: {}, for {} seconds".format(speed, seconds))
    self._left_speed(speed)
    self._right_speed(speed)
  ...
  def right(self, speed, seconds=None):
    ...
    """
    # Set motor speed and move both forward.
    print("Spinning right @ speed: {}, for {} seconds".format(speed, seconds))
    self._left_speed(speed)
    self._right_speed(speed)
    self._left.run(Adafruit_MotorHAT.FORWARD)
    self._right.run(Adafruit_MotorHAT.BACKWARD)
  ...
  def left(self, speed, seconds=None):
    ...
    """
    # Set motor speed and move both forward.
    print("Spinning left @ speed: {}, for {} seconds".format(speed, seconds))
    self._left_speed(speed)
    self._right_speed(speed)
    self._left.run(Adafruit_MotorHAT.BACKWARD)
    self._right.run(Adafruit_MotorHAT.FORWARD)
...
if __name__ == "__main__":
  ...
  zumo = Robot(left_trim=LEFT_TRIM, right_trim=RIGHT_TRIM)
  executor()
  rospy.spin()
